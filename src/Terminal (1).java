...
* Ausgabe auf einem Terminal zur Verfuegung.            
*    @author  P. Pepper und Gruppe                    
*    @version 1.1                            
* Durch das InfTech-Team modifizierte Version.
************************************************************************/
...
class Terminal {
    ...
    * @return die gelesene Zahl.
    ****************************************************************/
    public static double readDoubleLocalized () {
        StringTokenizer tokenizer = getTokenizer();
        while (true) {
            try {
    ...
    * @return die eingegebene Gleitpunktzahl.            
    ****************************************************************/
    public static double askDoubleLocalized (String prompt) {
        print(prompt);
        return readDoubleLocalized();
    }
